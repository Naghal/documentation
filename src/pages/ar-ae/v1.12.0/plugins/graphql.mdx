...
### إذا كان موقعك عبارة عن تطبيق واحد صفحة واحدة (SPA)
...
### إذا كان موقعك عبارة عن تطبيق محمل على الجانب الخادم (SSR)

تابع المثال التالي إذا كان التطبيق الخاص بك هو SSR. تأكد من أن "tracker.start()" يتم استدعاؤه مرة واحدة عندما يتم بدء التطبيق على الجانب العميل (في "useEffect" أو "componentDidMount").
...
ل [Relay](https://relay.dev/) يجب عليك وضع استدعاء "recordGraphQL" يدويًا في "NetworkLayer" التنفيذ. إذا كان لديك طريقة التنفيذ القياسية "Network.create"، فيجب عليك اتباع المثال التالي.
