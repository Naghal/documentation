...
<Aside type="tip">
نحن نملك أيضًا درسًا مفصلًا حول كيفية استخدام البرنامج الإضافي Zustand لالتقاط حالة مشروعك عند استخدام هذه المكتبة، يمكنك التحقق من ذلك [هنا] (/tutorials/zustand).
</Aside>
...
قم بتهيئة حزمة `@openreplay/tracker` كالمعتاد وقم بتحميل البرنامج الإضافي إليه. استدعاء البرنامج الإضافي وضبط اسم المخزن، وسيقوم هذا بإرجاع نسخة متتبعة مسماة تتمكن من استدعاءها بالمثال المخزن كمدخل لتمكين تتبع هذا المخزن.
...
يمكنك تخصيص سلوك البرنامج الإضافي بخيارات لتنظيف البيانات الخاصة بك. هي مشابهة للخيارات الموجودة في البرنامج الإضافي القياسي `createLogger`.
