...
سيحدث ملف المحدث (`makeUpReducer.js`) الحالة بما في ذلك قائمة المنتجات أو رسالة الخطأ التي تُعيدها عند وجود مشكلة.
...
وأخيرا، سيحدد ملف الإجراء واحدة واحدة، والتي ستقوم بإخذ قائمة المنتجات من واجهة برمجة التطبيقات الخارجية وتشغيل الإجراء الصحيح والحمولة:
