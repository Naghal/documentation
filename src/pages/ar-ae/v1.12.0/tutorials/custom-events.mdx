...
لهذا الدرس، سنستخدم مشروع Next.js الذي يتم إعداده بما يتوافق مع نفس البنية كما في الدرس التعليمي (https://docs.openreplay.com/tutorials/next)، لذلك لا تتردد في التحقق من ذلك إذا لم تفعل ذلك بالفعل.
...
بعد ذلك، يمكننا إعداد هذا المزود في ملف `_app.tsx` الخاص بنا مثل هذا:
```jsx
