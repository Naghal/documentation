...
إذا كان كل شيء يجري بشكل جيد، فيمكنك الحصول على قائمة بالصور التي تم بناؤها من الشفرة التي كان لديك، والتي جاهزة للتثبيت في مستودع Docker الخاص بك.
...
قم بإضافة قسم لكل صورة لديك في مستودع Docker الخاص بك مع المعلومات التالية:
