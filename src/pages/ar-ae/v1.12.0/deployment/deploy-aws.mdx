...
7. إضافة الوسوم: ضبط الإعدادات أو احفظ الإعدادات الافتراضية
...
أسهل طريقة لمعالجة SSL في AWS هي إعداد توزيع الحمولة (ELB) وتشغيل OpenReplay وراءه. الخيار الآخر هو إنشاء شهادة SSL أو استخدام شهادتك الخاصة والإشارة إلى النطاق الفرعي الخاص بك (أي openreplay.mycompany.com) إلى نموذج OpenReplay. المزيد على كلا الخيارين أدناه.

### إعداد توزيع الحمولة AWS (الخيار 1)

1. انتقل إلى 'EC2' > 'توزيع الحمولة'
2. 'إنشاء توزيع الحمولة' واختر *Application Load Balancer*
3. إضافة مستمع إلى HTTPS (احتفظ بهذا الوحيد) وتأكد من تحديد نفس الشبكة (الشبكات) فيها يتم تشغيل نموذج OpenReplay.
