...
خدمة قاعدة البيانات الخاصة بنا، Postgres، يتم تثبيتها بشكل افتراضي مع OpenReplay وتعمل في حاوية مخصصة في نموذجك لتخفيض تكاليف النشر. إذا كنت تبحث عن تطورات أكبر في التخطيط أو عمليات أسهل، يمكنك لا تزال استخدام Postgres خارجي (أي AWS RDS أو GCP Cloud SQL).
