...
`200`: الاستجابة المرسلة كJSON في الجسم
...
| اسم     | نوع                              | الوصف                                                                        |
|----------|-----------------------------------|------------------------------------------------------------------------------------|
| قيمة    | مصفوفة من السلاسل غير حساسة للحالة | قائمة القيم (الافتراضي:[])                                                    |
| نوع     | سلسلة غير حساسة للحالة           | سمة المرشح (مطلوب)                                                    |
| مصدر   | سلسلة غير حساسة للحالة           | اسم سمة البيانات لنوع=metadata (الافتراضي:"")                 |
| مشغل   | سلسلة حساسة للحالة           | المشغل لاستخدامه لكل قيمة، يمكن أن يكون "contains" أو "is" (الافتراضي:"contains") |
...
على سبيل المثال، إذا كنت تبحث عن الجلسات التي لها بيانات وصفية معينة (أي قيمة):
...
معرف المستخدم 'openreplay' و `metadata.plan` يحتوي على 'trial' أو 'free'.
