...
### إذا كان موقعك هو تطبيق واحد صفحة (SPA)
...
تابع المثال التالي إذا كان التطبيق SSR. تأكد من أن "tracker.start()" يتم استدعاؤه مرة واحدة عندما يتم بدء التطبيق على الجانب الخاص بالعميل (في "useEffect" أو "componentDidMount").
...
ل [Relay](https://relay.dev/) يجب عليك وضع استدعاء "recordGraphQL" في "NetworkLayer" التنفيذ. إذا كان لديك طريقة "Network.create" القياسية للتنفيذ، فيجب عليك اتباع المثال التالي.
