...
<Aside type="tip">
  لدينا أيضًا درسًا مفصلًا حول كيفية استخدام البرنامج الإضافي Zustand لالتقاط حالة مشروعك عند استخدام هذه المكتبة، يمكنك التحقق من ذلك [هنا] (/tutorials/zustand).
</Aside>
