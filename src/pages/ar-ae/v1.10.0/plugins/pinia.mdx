...
يتيح لك هذا البرنامج الإضافي تلقي التغييرات/الحالة الخاصة بـ Pinia وفحصها لاحقًا أثناء إعادة تشغيل تسجيلات الجلسات. هذا من المفيد جدًا لفهم وإصلاح المشاكل.
