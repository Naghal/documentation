...
العنوان: "الجلسات"
metaTitle: "الجلسات"
metaDescription: "كيفية استرجاع جميع الجلسات لمستخدم معين."
---
...
| الاسم | النوع | الوصف |
|----------|-------------|-------------|
| projectKey | string | مفتاح المشروع الذي تتتبعه (مطلوب) |
| userId | string | مفتاح المستخدم الذي تم تعيينه عبر `tracker.setUserID` (مطلوب) |
