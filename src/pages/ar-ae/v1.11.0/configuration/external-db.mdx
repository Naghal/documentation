...
تأتي خدمة قاعدة البيانات الخاصة بنا، Postgres، مثبتة افتراضيًا مع OpenReplay وتعمل في حاوية مخصصة في نموذجك لتقليل تكاليف النشر. إذا كنت تبحث عن تطور أكبر في التزام أو عمليات أسهل، يمكنك لا تزال استخدام Postgres خارجي (أي AWS RDS أو GCP Cloud SQL).
...
1. أولاً، قم بنسخ احتياطي لقاعدة البيانات المحلية:
