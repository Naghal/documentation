...
1. تأكد من أن جهازك قد بدأ ثم اتصل به من خلال SSH كمسؤول
...
> **ملاحظة:** إذا لم يكن لديك شهادة، فأنشئ واحدة تتجدد تلقائيًا للنطاق الفرعي (الذي تم توفيره أثناء التثبيت) باستخدام Let's Encrypt. ببساطة اتصل بجهاز OpenReplay، قم بتشغيل `cd /var/lib/openreplay/openreplay/scripts/helmcharts && bash certmanager.sh` واتبع الخطوات.
