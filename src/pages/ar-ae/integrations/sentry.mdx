...
### الخلفية
وإلا، إذا كنت تستخدم SDK Sentry للخلفية، يجب على رمز الجلسة الانتشار من الواجهة الأمامية في كل طلب تريد تتبعه. يمكن القيام بذلك باستخدام رأس HTTP مخصص. في المثال أدناه، نستخدم API `fetch` لإرسال ذلك الرأس.
