...
```
", '\n\nلأجل أن يربط OpenReplay إدخال سجل Elasticsearch مع جلسة المستخدم المسجلة، يجب أن يتم تدفق نشاط مميز كجزء من كل خطأ خلفي يرغب في تتبعه.\n\nبالأسفل هو مثال في Python باستخدام Monkey Patching.\n\n
```python
import sys
import traceback
#...
