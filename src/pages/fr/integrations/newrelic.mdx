...
Pour que OpenReplay associe une entrée de journal NewRelic à la session utilisateur enregistrée, un jeton unique doit être propagé en tant que `custom_parameter` à chaque erreur de backend que vous souhaitez suivre.
