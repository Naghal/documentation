...
5. Exécutez `mc ilm set --id mobs --expiry-days 14 minio/mobs` (c'est-à-dire nettoyer automatiquement les enregistrements 14 jours après leur création)
6. Utilisez `exit` pour quitter le conteneur Minio
7. Exécutez `:quit` pour quitter l'interface de ligne de commande Kubernetes
