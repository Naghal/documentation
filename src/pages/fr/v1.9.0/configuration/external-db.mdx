...
La première étape consiste à mettre à jour toutes les variables `postgres` dans `openreplay / scripts / helmcharts / vars.yaml` et à les pointer vers la base de données externe:
