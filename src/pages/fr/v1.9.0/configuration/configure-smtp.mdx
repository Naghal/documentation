...
Pour activer SMTP, modifiez `openreplay/scripts/helmcharts/vars.yaml` et mettez à jour les variables d'environnement ci-dessous dans la section `email`:
...
6. Utilisez les paramètres et informations d'identification SMTP affichés pour configurer SMTP dans OpenReplay. Modifiez `openreplay/scripts/helmcharts/vars.yaml` et mettez à jour les variables d'environnement ci-dessous dans la section `email`:
