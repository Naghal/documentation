...
Ce plugin vous permet de capturer les demandes `GraphQL` et de les inspecter plus tard lors de la lecture des enregistrements de session. C'est très utile pour comprendre et résoudre les problèmes.

Le plugin `GraphQL` est compatible avec les implémentations Apollo et Relay.
