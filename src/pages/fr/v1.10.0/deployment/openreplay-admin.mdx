...
Le CLI est utile pour gérer les aspects de base de votre instance OpenReplay, tels que le redémarrage ou la réinstallation d'un service, l'accès aux journaux d'un composant ou simplement le contrôle de l'état de vos services arrière-plan.
