...
## Mettez à jour vos variables Postgres

La première étape consiste à mettre à jour toutes les variables `postgres` dans `/var/lib/openreplay/vars.yaml` et à les pointer vers la base de données externe:
...
> **Note:** Si vous commencez à partir de zéro et n'avez pas encore installé OpenReplay, procédez simplement à la configuration et ignorez les étapes suivantes.
...
4. Enfin, redémarrez tous les services OpenReplay:
