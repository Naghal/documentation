...
<Aside type="tip">
Nous avons également un tutoriel détaillé sur la façon d'utiliser le plugin Zustand pour capturer l'état de votre application lors de l'utilisation de cette bibliothèque, vous pouvez le consulter [ici](/tutorials/zustand).
</Aside>
