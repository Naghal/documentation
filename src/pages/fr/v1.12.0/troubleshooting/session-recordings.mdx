...
Contrairement aux styles, les images ne sont pas mises en cache par OpenReplay mais récupérées lors d'une reprise de session. Ils devraient donc être accessibles publiquement. S'ils sont sur un CDN, assurez-vous de conserver les anciennes versions de vos images afin de pouvoir rejouer correctement les anciens enregistrements de session.
