...
Si votre suiveur OpenReplay est configuré à l'aide du snippet JS, remplacez simplement l'occurrence `.../openreplay.js` par `.../openreplay-assist.js`. Ci-dessous un exemple de la façon dont le script devrait ressembler après le changement:
...
- `callConfirm`: Personnalisez le texte et / ou la mise en page de la fenêtre de demande d'appel.
- `controlConfirm`: Personnalisez le texte et / ou la mise en page de la fenêtre de demande de contrôle à distance.
